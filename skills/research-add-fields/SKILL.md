...
description: >
  Add more field definitions to an existing research outline.
  Use after /deep-research:research when the user wants to expand the
  research dimensions with additional data fields.
