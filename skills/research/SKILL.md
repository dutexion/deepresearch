...
description: >
  ...
  Use when the user says "research", "investigate", "survey", "outline",
  or wants to start a structured research workflow on any topic.
  Supports academic, technical, market, and due diligence research.
argument-hint: "<topic>"
allowed-tools: Read, Write, Glob, WebSearch, Agent, AskUserQuestion
---
