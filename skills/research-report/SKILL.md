...
description: >
  Generate a comprehensive markdown report from deep research results.
  Use after /deep-research:research-deep has completed. Summarizes all fields,
  skips uncertain values, and generates a table of contents with anchor links.
